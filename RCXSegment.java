...
class RCXSegment extends Canvas {

	private Image rcx_image;
	...
	private int digits[][] = {
		...
		{0,0,0,0,0,0,0},	//ZeichenLeer
		{0,0,0,1,0,0,0},	//Zeichen_
	...
	public RCXSegment(Image img) { //(TextLCDApplet owner)
		this.rcx_image = img;
	}
	...
	*/
	public synchronized void update(Graphics g) {
		...
		offGraphics.drawImage(rcx_image, pos.x, pos.y, this); // paint the image
